export function LogoCloud() {
  const logos = [
    ...
    },
    {
      name: "Stripe",
      logo: (
        <svg className="h-6 w-auto" viewBox="0 0 512 214" fill="currentColor">
    ...
    },
    {
      name: "Raycast",
      logo: (
        <svg className="h-5 w-auto" viewBox="0 0 512 512" fill="none">
    ...
    },
    {
      name: "GitHub",
      logo: (
        <svg className="h-6 w-auto" viewBox="0 0 98 96" fill="currentColor">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
      ...
      <div className="relative">
        ...
        <div className="flex animate-marquee">
          {duplicatedLogos.map((logo, index) => (
            <div
              key={`${logo.name}-${index}`}
              className="flex-shrink-0 mx-10 flex items-center gap-2 text-muted-foreground/60 hover:text-foreground transition-colors duration-300"
            >
              {logo.logo}
